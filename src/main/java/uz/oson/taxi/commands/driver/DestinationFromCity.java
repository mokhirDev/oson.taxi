...
public class DestinationFromCity implements BotPage, Action {
    ...
    public String nextPage(Update update) {
        ...
        if (city != null) {
            update(update);
            return PageIdGenerator.generate(BotPageStageEnum.DESTINATION_TO_CITY, UserTypeEnum.DRIVER);
        }
        return getPageId();
    }
    ...
    public List<BotApiMethod<?>> handle(Update update) {
        ...
        userService.setCurrentPage(BotPageStageEnum.DESTINATION_FROM_CITY, chatId);

        String message = messageFactory.getPageMessage(PageMessageEnum.SELECT_DISTANCE, locale) +
                messageFactory.getPageMessage(PageMessageEnum.SELECT_ROUTE, locale) +
    ...
    public String getPageId() {
        return PageIdGenerator.generate(
                BotPageStageEnum.DESTINATION_FROM_CITY,
                UserTypeEnum.DRIVER
        );
    }
